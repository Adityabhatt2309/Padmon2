...
import styles from '../../styles/MultipleSingleNFTStake.module.css';
...
const MultiSingleNFTStakeCard = (props) => {
  ...
  return (
    <div>
         <div className="flex">
      <div className='w-full mt-2 md:m-3'>
        <div className=" text-black flex justify-between w-full border border-[#0082FF]">
          <div class="panel-heading w-full" role="tab" id="accordion">
            <Link
              role="button"
              onClick={() => {
                setShow(!show);
            ...
            >
              <div className={`${styles.wrpbison1}`}>
                <div className="bison-c1 bg-bison">
                  <div className={`img-bison`}>
                    <img src={props.data.image} className={styles.imggenft}/>
                  </div>
                </div>
                <div className="token1">
                  <h3 className='text-color-nft'>{nftSymbol} NFT</h3>
                </div>
                <div className="apr">
                      <div className="calcul-wrp">
                        <div className="wrp-arp">
                          ...
                          <div className="apr-c1">
                            <h3 className='text-color-nft'>{apr}%</h3>
                          </div>
                        </div>
                ...
                <div className="bison-btn">
                  { props.data.status == 1 ?
                    <button
                      className='active-section2 text-white p-2 rounded-md font-bold'
                      onClick={() => {
                  ...
                  {userInfo.length > 0 ? (
                    <button className='active-section2  ml-2 text-white p-2 rounded-md font-bold' onClick={unstakeToggleRedeemable}>
                      Unstake
                    </button>
                  ):""}
                  {userReward > 0 ? (
                    <button onClick={claim} className='active-section2'>Claim</button>
                  ):""}
            ...
            {show ? (
              <div className={styles.accordian}>
                <div id={"collapse" + props.index} role="tabpanel" className='w-full'>
                  <div class="panel-body">
                    <div className={styles.accordianPart}>
                      <div className="w-full" style={{display:"flex",justifyContent:"space-between",width:"100%"}}>
                          ...
                          <div className="wrp-arp2" style={{display:"flex", justifyContent:"space-between",width:"100%"}}>
                            <div className="apr-c">
                              <p>End Time</p>
                            </div>
                          ...
                          <div className="wrp-arp2 flex flex-col items-center md:flex-row justify-between w-full">
                            <div className="apr-c bscscan" style={{display:"flex", justifyContent:"space-between",width:"100%"}}>
                              <a
                                target="_blank"
...
{/* 
          ...
          {showStake ? (
            <div className="w-full justify-center flex absolute items-center inset-0 z-10">
              <div
                isOpen={depositmodal}
              ...
              >
                ...
                <footer>
                  {approval > 0 && approval > stakingAmountOg * damount && (
                    <>
                      <button
                        className='bg-blue-500 m-2 text-black p-2 rounded-md font-bold'
          ...
          {approvewizard ? (
            <div className="flex justify-center items-center inset-0 z-20">
              <div
                isOpen={modal}
                toggle={toggle}
                centered={true}
