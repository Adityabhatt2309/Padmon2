                ...
                <div className="bison-btn p-4">
                  {wallet.address &&
                    ...
                    STAKE_CONTRACT[props.index].status == 1 && (
                      <button className=" rounded-md pl-3 pr-3 pt-1 pb-1 text-white  font-bold active-section2" onClick={depositToggle}>Stake</button>
                    )}
                  {wallet.address &&
                    userStaked > 0 &&
                    !claimAllowed &&
                    STAKE_CONTRACT[props.index].fee == 0 && (
                      <button className=" rounded-md p-3  font-bold active-section2" onClick={unstakeToggle}>Unstake</button>
                    )}
                  {wallet.address &&
                    userStaked > 0 &&
                    STAKE_CONTRACT[props.index].fee == 1 && (
                      <button
                      className=" rounded-md p-3  font-bold active-section2"
                  ...
                  {wallet.address && userStaked > 0 && claimAllowed && (
                    <button className="bg-white rounded-md p-3  font-bold active-section2" onClick={claim}>Claim</button>
                  )}
...
{
    modal?<div className="flex justify-center absolute items-start top-30 inset-0 z-30">
...
{
    unstakeRedeemableModal?<div className="flex justify-center absolute items-start top-52 inset-0 z-20">
...
<footer>
        <button className="depositButton mr-auto ml-auto mb-5 bg-blue-500 rounded-sm p-2" onClick={unstakeRedeemable}>Unstake</button>
...
{
    unstakeModal?<div className="flex justify-center absolute items-start top-10 inset-0 z-10">
...

    {
        ...
        <footer>
            {
                ...
                <button className="depositButton mr-3 p-2 bg-blue-500 rounded-sm" onClick={depositToken}>Deposit</button>
            }
            {
                (approval == 0 || approval < stakingAmountOg*damount) &&
        ...
        <div className="mb-3 p-4 text-white">
              <div className="faq-answer" itemprop="acceptedAnswer">
                <div itemprop="text">
                {
                    show?<div className="bottom-list gap-5 flex flex-col md:flex-row justify-between max-w-full">
                    ...
                    <div className="wrp-arp2 flex justify-between flex-col md:flex-row flex-1">
                      ...
                      <div className="apr-c bscscan">
                        <a target="_blank" href={buyLink + stakeTokenAddress} className="active-section2">
                          Buy {symbol} Token
                        </a>
                      </div>
                    </div>
